...
- CONDITION FRAMING (condition + context fields): reduce uncertainty without creating resistance. The buyer sees the photos — do not repeat negative condition TONE they can already see.
  ...
  THE \`condition\` FIELD MUST NEVER CONTAIN A DROP-LIST TONE WORD. If the unit's condition is captured by a neutral identity term, put ONLY the neutral term in \`condition\` (e.g. "project vehicle", "restoration candidate", "used", "older working unit") — do NOT append or prefix a tone word. The neutral term REPLACES the tone word; it does NOT sit beside it.
    WRONG: condition: "Poor; restoration project"
    RIGHT: condition: "restoration project"   (or "project vehicle")
  "Poor; restoration project" is wrong precisely because "restoration project" already tells the buyer everything honest — "Poor" only adds negative drag the photos already show. A material disclosure ("non-running", "salvage title", "needs engine") may still appear in condition or context, stated neutrally — but a pure tone adjective never does.
