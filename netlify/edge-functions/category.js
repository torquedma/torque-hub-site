...
const SUBCATEGORY_LEAVES = {
  ...
  'race-trailers':                         { subs: ['Race Trailer'],               label: 'Race Trailers',                hub: 'trailers-for-sale' },
  'living-quarters-trailers':             { subs: ['Living Quarters Trailer'],    label: 'Living Quarters Trailers',     hub: 'trailers-for-sale' },
